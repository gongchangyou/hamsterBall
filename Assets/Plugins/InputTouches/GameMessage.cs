...
public class GameMessage : MonoBehaviour {
	...
	static public void Init(){
		...
		if(gameMessage.displayText==null){
			...
			gameMessage.displayText.alignment = TextAlignment.Left;
			gameMessage.displayText.anchor = TextAnchor.LowerLeft;
			gameMessage.displayText.color = new Color(152.0f / 255, 25.0f / 255, 173.0f / 255, 1.0f);
			gameMessage.displayText.fontSize = 50;
			gameMessage.displayText.transform.localPosition = new Vector3(0.03f, 0.2f, 0);
		}
